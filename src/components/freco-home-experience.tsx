...
import { ArrowDown, ArrowRight, ArrowUpRight, Compass } from "lucide-react";
      ...
      <section className="relative min-h-[820px] overflow-hidden bg-ink text-white lg:min-h-[900px]">
        ...
        <div className="relative mx-auto min-h-[820px] max-w-[1440px] px-6 pb-14 pt-32 lg:min-h-[900px] lg:px-12 lg:pb-16">
          <div className="grid min-h-[670px] items-end gap-14 lg:grid-cols-[1fr_0.72fr] lg:gap-20">
            ...
            <div className="relative min-w-0 self-end overflow-hidden lg:mb-4 lg:pt-12">
              <Image src="/freco-art-logo-transparent.png" alt="FRECO ART LTD logo" width={464} height={459} className="hero-logo ml-auto h-auto w-full max-w-[320px] object-contain object-right" sizes="(max-width: 1024px) 75vw, 320px" />
            </div>
